      ...
      <div className="about-wrapper">
        ...
        <div className="cheerUs">
          ...
          <p>
            ...
            sommes là pour vous aider à profiter pleinement de votre expérience
            de jeu.
          </p>
          <br />
          <p>
            Nous comprenons que parfois vous pouvez rencontrer des défis
            techniques, des questions sur le gameplay ou des problèmes de
            compte, et nous sommes là pour vous offrir notre soutien et résoudre
            vos problèmes.
          </p>
          <br />
          <p>
            Que vous soyez un nouveau joueur ou que vous ayez déjà de
            l'expérience dans notre jeu, nous sommes déterminés à vous offrir un
            soutien de qualité pour vous aider à profiter pleinement de
            l'univers de jeu que nous avons créé.
          </p>
