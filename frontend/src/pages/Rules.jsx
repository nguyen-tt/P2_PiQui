    ...
    <>
      ...
      <div className="centering">
        <div className="rules">
          ...
          <p>
            Pour ça, tu vas pouvoir cliquer sur différents critères dans la
            barre des critères à gauche des personnages. Par exemple: "est-ce
            que le personnage que je dois deviner porte un chapeau ?" Je vais
            cliquer sur le critère chapeau pour avoir ma réponse !
          </p>
          <p>
          ...
          <p>
            ...
            des personnages pour vérifier si c'est le personnage mystère. Et si
            tu es sûr(e) de toi, tu n'es même pas obligé(e) d'attendre !
          </p>
